...
// @LINE:7
private[this] lazy val controllers_Application_hello1 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("hello"))))
...
def documentation = List(("""GET""", prefix,"""controllers.Application.index"""),("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """hello""","""controllers.Application.hello(n:String)"""),("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """assets/$file<.+>""","""controllers.Assets.at(path:String = "/public", file:String)""")).foldLeft(List.empty[(String,String,String)]) { (s,e) => e.asInstanceOf[Any] match {
...
case controllers_Application_hello1(params) => {
   call(params.fromQuery[String]("n", None)) { (n) =>
        invokeHandler(controllers.Application.hello(n), HandlerDef(this, "controllers.Application", "hello", Seq(classOf[String]),"GET", """""", Routes.prefix + """hello"""))
   }
}
